...
phone_number = input('Zadejte své telefonní číslo: ')

if not phone_num_length(phone_number.replace(' ','')):
    print('Toto není správný formát telefonního čísla.')
    exit(0)

phone_message = input('Zadejte zprávu, kterou chcete poslat: ')

print('Cena Vaší SMS zprávy je', message_price(phone_message), 'Kč.')
